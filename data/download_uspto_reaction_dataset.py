"""Module for downloading USPTO dataset."""
import os
import logging
...
if __name__ == "__main__":
    # TODO: convert this into an one-off script
    load_uspto(data_dir="/data/datasets/uspto/raw", save_dir="/data/datasets/uspto/featurized", subset="FULL", featurizer="plain")
    load_uspto(data_dir="/data/datasets/uspto/raw", save_dir="/data/datasets/uspto/featurized", subset="MIT", featurizer="plain")
    load_uspto(data_dir="/data/datasets/uspto/raw", save_dir="/data/datasets/uspto/featurized", subset="STEREO", featurizer="plain")
    load_uspto(data_dir="/data/datasets/uspto/raw", save_dir="/data/datasets/uspto/featurized", subset="50K", featurizer="plain")
